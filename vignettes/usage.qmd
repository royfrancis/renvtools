...
<p style="color: #8a6d3b;background-color: #fcf8e3;border-color:#faebcc;padding: 6px;border-radius: 4px;" style="inline-block">
<i class="fas fa-exclamation-circle"></i> &nbsp; Reading a loackfile and then writing it may not give identical lockfiles as NAs and NULLs may be discarded.
</p>
...
```{r}
compare_locks(l)[, 1:12] %>% as.data.frame()
```
